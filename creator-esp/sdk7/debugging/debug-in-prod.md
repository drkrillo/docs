...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/oPnXBby9S6MrsW83Y9qZ/sdk7/debugging/debug-in-prod
---
...
Before you deploy your scene to Decentraland, make sure the scene runs well in preview using the latest version of the Decentraland SDK. See [debug in preview](../../../creator/sdk7/debugging/debug-in-preview.md).
...
See [The test server](../../../creator/sdk7/publishing/publishing.md#the-test-server) for details.
