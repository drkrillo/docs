...
metaLinks:
  alternates:
    - https://app.gitbook.com/s/oPnXBby9S6MrsW83Y9qZ/sdk7/debugging/report-bug
---
...
* Rule out that the problem could be caused by how your scene is built. See [Debug in Preview](../../../creator/sdk7/debugging/debug-in-preview.md) and [Debug in Prod](../../../creator/sdk7/debugging/debug-in-prod.md) for tips.
...
2. Click **Get Started** next to **Bug Report**. ![](../../.gitbook/assets/report-bug.png)
...
![](../../.gitbook/assets/submit-issue.png)
