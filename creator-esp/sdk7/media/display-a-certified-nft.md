...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/oPnXBby9S6MrsW83Y9qZ/sdk7/media/display-a-certified-nft
---
...
{% hint style="info" %}
**💡 Tip**: In the [Scene Editor](../../../creator/scene-editor/get-started/about-editor.md), you can use an **NFT** [Smart Item](../../../creator/scene-editor/interactivity/smart-items.md) for a no-code way to achieve this.
{% endhint %}
