...
|---------|---------|---------------|
| [Realm Provider](services.md#realm-provider) | Describes available realms and services | [API](../apis/realm-provider/README.md) |
| [Auth Server](services.md#auth-server) | Authentication service | [API](../apis/auth-server/README.md) |
| [Comms Gatekeeper](services.md#comms-gatekeeper) | LiveKit access control | [API](../apis/comms-gatekeeper/README.md) |
| [Archipelago Workers](services.md#archipelago-workers) | Communications clustering | [API](../apis/archipelago-workers/README.md) |

### Content & Social Services

| Service | Purpose | API Reference |
|---------|---------|---------------|
| [Worlds](services.md#worlds) | Isolated scene hosting | [API](../apis/worlds/README.md) |
| [Events](services.md#events) | Event management | [API](../apis/events/README.md) |
| [Places](services.md#places) | Points of interest | [API](../apis/places/README.md) |
| [Social Service](services.md#social-service) | Friends & communities | [API](../apis/social-service/README.md) |
| [Atlas Server](services.md#atlas-server) | Map data | [API](../apis/atlas-server/README.md) |

### Asset & Media Services

| Service | Purpose | API Reference |
|---------|---------|---------------|
| [Asset Bundle Registry](services.md#asset-bundles) | Optimized asset management | [API](../apis/asset-bundle-registry/README.md) |
| [Camera Reel](services.md#camera-reel) | Screenshot management | [API](../apis/camera-reel/README.md) |

### Platform Services

| Service | Purpose | API Reference |
|---------|---------|---------------|
| [Credits Server](services.md#credits-server) | Virtual credits system | [API](../apis/credits-server/README.md) |
| [Badges](services.md#badges) | User achievement system | [API](../apis/badges/README.md) |
| [Notifications](services.md#notifications) | User notifications | [API](../apis/notifications-workers/README.md) |
| [Events Notifier](services.md#events-notifier) | Event-based notifications | [API](../apis/events-notifier/README.md) |
| [Exploration Games](services.md#exploration-games) | Onboarding games | [API](../apis/exploration-games/README.md) |
...
* [Developer Standards](../developer-standards/) - Coding and documentation standards
