...
![](https://github.com/decentraland/docs-creator/blob/main/images/media/ecs-big-picture.png)
...
![Armature](https://github.com/decentraland/docs-creator/blob/main/images/editor/components-example.png)
...
![Armature](https://github.com/decentraland/docs-creator/blob/main/images/media/ecs-components-new.png)
...
![nested entities](https://github.com/decentraland/docs-creator/blob/main/images/media/ecs-nested-entities-new.png)
...
![Armature](https://github.com/decentraland/docs-creator/blob/main/images/editor/entity-tree-example.png)
...
The `engine.CameraEntity` entity represents the player's camera. Fetch the camera's `Transform` component to get the camera's position and rotation. You can also fetch the camera's `CameraMode` component to know know if the player is using 1st or 3rd person camera mode, see \[camera mode]\(\{{< ref "/content/creator/sdk7/interactivity/user-data.md#check-the-players-camera-mode">\}}).
