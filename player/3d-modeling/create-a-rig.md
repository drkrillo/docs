...
![](https://github.com/decentraland/docs-creator/blob/main/images/3d-models-and-animations/create-rig/01_add_armature.gif)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/3d-models-and-animations/create-rig/02_bone_head_tail.png)

_Bone structure._

![](https://github.com/decentraland/docs-creator/blob/main/images/3d-models-and-animations/create-rig/03_bone_pivot_rotation.gif)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/3d-models-and-animations/create-rig/04_bone_roll.gif)

_Fixing the bone roll._

![](https://github.com/decentraland/docs-creator/blob/main/images/3d-models-and-animations/create-rig/05_toggle_axes.png)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/3d-models-and-animations/create-rig/06_bone_roll_fingers.gif)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/3d-models-and-animations/create-rig/07_symmetrize.gif)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/3d-models-and-animations/create-rig/08_skinning.gif)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/3d-models-and-animations/create-rig/09_weight_paint.gif)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/3d-models-and-animations/create-rig/10_weight_paint_tools.png)

_Change the Blend to add or remove influence. Make sure Symmetry is right._

![](https://github.com/decentraland/docs-creator/blob/main/images/3d-models-and-animations/create-rig/11_weight_paint_tools_02.png)

Use the _**Blur**_ tool ont the left side of the screen to smooth the weight paint and make it more even.

![](https://github.com/decentraland/docs-creator/blob/main/images/3d-models-and-animations/create-rig/12_blur_tool.gif)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/3d-models-and-animations/create-rig/13_IK_example_mch_arm.gif)

_IK use in a mechanical arm._

![](https://github.com/decentraland/docs-creator/blob/main/images/3d-models-and-animations/create-rig/14_IK_example_buddha.gif)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/3d-models-and-animations/create-rig/15_Duplicating_bones.gif)

_Duplicate the bones and move them to a different layer._

![](https://github.com/decentraland/docs-creator/blob/main/images/3d-models-and-animations/create-rig/16_uncheck_deform.png)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/3d-models-and-animations/create-rig/17_IK_bone.gif)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/3d-models-and-animations/create-rig/18_constraint_tab.png)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/3d-models-and-animations/create-rig/19_creating_pole_target.gif)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/3d-models-and-animations/create-rig/20_pole_target_rotation.png)

_IK chain and deform bones are not aligned anymore because of pole target._

![](https://github.com/decentraland/docs-creator/blob/main/images/3d-models-and-animations/create-rig/21_pole_target_rotation_fix.png)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/3d-models-and-animations/create-rig/22_constraints.gif)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/3d-models-and-animations/create-rig/23_symmetrize_constraints.gif)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/3d-models-and-animations/create-rig/24_b-bone_scale.gif)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/3d-models-and-animations/create-rig/25_bone_groups.png)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/3d-models-and-animations/create-rig/26_bone_shape.gif)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/3d-models-and-animations/create-rig/27_bone_shape_edit.gif)
