...
1.  In the Collection's section, click on the **Create Collection** button.
    ...
    ![](https://github.com/decentraland/docs-creator/blob/main/images/media/collections-page.png)
2.  Select the Linked Wearable Collection option by click on the **Create Collection** button under the Linked Collections section.
    ...
    ![](https://github.com/decentraland/docs-creator/blob/main/images/media/collection-creation-selector-modal.png)
3.  Choose a name for the collection and link the collection to your NFT collection by setting its contract address and the network it is in. **The contract will be validated to be sure it complies with the NFT contracts standards.**
    ...
    ![](https://github.com/decentraland/docs-creator/blob/main/images/media/linked-wearables/linkedw-collection-creation.png)
...
1.  Click on the **New items** button.
    ...
    ![](https://github.com/decentraland/docs-creator/blob/main/images/media/linked-wearables/linkedw-empty-collection.png)
2.  Select the **Singe items** option.

    ![](https://github.com/decentraland/docs-creator/blob/main/images/media/linked-wearables/multiple-items-upload.png)
3.  Follow the steps to upload and configure your wearable as it is described in the \[creating wearables guidelines]\(\{{< ref "/content/creator/wearables-and-emotes/wearables/creating-wearables.md" >\}}) and configure how it will be linked to your NFTs. Check the "[How do Linked Wearables represent NFTs?](linked-wearables.md#how-do-linked-wearables-represent-nfts)" section for more information on how to configure it.
    ...
    ![](https://github.com/decentraland/docs-creator/blob/main/images/media/linked-wearables/linkedw-mapping.png)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/media/linked-wearables/collection-options-menu.png)

2. Copying the identifier that's below the the text field:

![](https://github.com/decentraland/docs-creator/blob/main/images/media/linked-wearables/edit-collection-urn-modal.png)
...
3.  Click on the **Browse yor computer** link to open your file manager and select all the zips containing your wearables.
    ...
    ![](https://github.com/decentraland/docs-creator/blob/main/images/media/linked-wearables/multiple-files-select-in-bulk.png)
4.  Review if all the files are correct or if they need to be fixed. In this case, the model of the wearable isn't set or the `wearable.json` file has an incorrectly set representation.
    ...
    ![](https://github.com/decentraland/docs-creator/blob/main/images/media/linked-wearables/multiple-files-with-errors.png)
5.  Fix any errors by clicking the **Add more** button and re-uploading the failed files with the same name or by dismissing the errors using the trash icon on the top right section of the modal.
    ...
    ![](https://github.com/decentraland/docs-creator/blob/main/images/media/linked-wearables/multiple-files-upload-correct-file.png)
6.  Upload all wearables by clicking **Upload items**.

    ![](https://github.com/decentraland/docs-creator/blob/main/images/media/linked-wearables/multiple-files-without-errors.png)
7.  Be patient, this might take a while!

    ![](https://github.com/decentraland/docs-creator/blob/main/images/media/linked-wearables/multiple-files-uploading.png)
8.  Success! Your items are now available in your collection.

    ![](https://github.com/decentraland/docs-creator/blob/main/images/media/linked-wearables/multiple-files-upload-success.png)
9.  Select if your collection is a programmatic or a standard one. Check the [NFT Collections & Linked Wearables Collections](linked-wearables.md#nft-collections--linked-wearables-collections) section to correctly set which collection type you're building items for.
    ...
    ![](https://github.com/decentraland/docs-creator/blob/main/images/media/linked-wearables/collection-type-selector.png)
...
1.  Click on the meatballs menu (three horizontal dots) on the right of the item that you want to see in world. A dropdown will appear. Select **See in Decentraland**.
    ...
    ![](https://github.com/decentraland/docs-creator/blob/main/images/media/linked-wearables/see-in-world-button.png)
2.  The Decentraland World will open. Navigate to your backpack to see the wearable.

    ![](https://github.com/decentraland/docs-creator/blob/main/images/media/linked-wearables/see-in-world-item.png)
...
1.  Click on the collection name.
    ...
    ![](https://github.com/decentraland/docs-creator/blob/main/images/media/linked-wearables/edit-collection-name.png)
2.  Choose a new name for the collection and click on the save button.

    ![](https://github.com/decentraland/docs-creator/blob/main/images/media/linked-wearables/edit-collection-name-modal.png)
...
2.  A Confirmation modal will appear, if you wish to proceed, click **Ok**, otherwise click on **Cancel**.
    ...
    ![](https://github.com/decentraland/docs-creator/blob/main/images/media/linked-wearables/delete-collection-confirmation-modal.png)
...
1.  Click on the meatballs menu (three horizontal dots) on the right of the item that you want to see in world. A dropdown will appear. Select **Open in editor**.
    ...
    ![](https://github.com/decentraland/docs-creator/blob/main/images/media/linked-wearables/edit-single-wearable.png)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/media/linked-wearables/edit-wearable-mapping.png)
...
1.  Click on the meatballs menu (three horizontal dots) on the far right of the set of buttons. A dropdown will appear. Select **Edit in bulk**.
    ...
    ![](https://github.com/decentraland/docs-creator/blob/main/images/media/linked-wearables/edit-multiple-files-bulk-button.png)
2.  A modal similar to de one in the **Uploading models in bulk** will appear. Click on the **Browse your computer** link to open your file manager.
    ...
    ![](https://github.com/decentraland/docs-creator/blob/main/images/media/linked-wearables/edit-multiple-files-modal.png)
3.  Select all the ZIP files of the items that will be edited.

    ![](https://github.com/decentraland/docs-creator/blob/main/images/media/linked-wearables/multiple-files-select-in-bulk.png)
4.  Review if all the files are correct or if they need to be fixed. In this case, the model of the wearable isn't set or the `wearable.json` file has an incorrectly set representation.

    ![](https://github.com/decentraland/docs-creator/blob/main/images/media/linked-wearables/edit-multiple-files-with-errors.png)
5.  Fix any errors by clicking the **Add more** button and re-uploading the failed files with the same name or by dismissing the errors using the trash icon on the top right section of the modal.

    ![](https://github.com/decentraland/docs-creator/blob/main/images/media/linked-wearables/multiple-files-upload-correct-file.png)
6.  Upload all wearables by clicking **Upload items**.

    ![](https://github.com/decentraland/docs-creator/blob/main/images/media/linked-wearables/edit-multiple-files-without-errors.png)
7.  Be patient, this might take a while!

    ![](https://github.com/decentraland/docs-creator/blob/main/images/media/linked-wearables/edit-multiple-files-uploading.png)
8.  Success! Your items are now available in your collection. Check the forum post for any updates from the curator.

    ![](https://github.com/decentraland/docs-creator/blob/main/images/media/linked-wearables/edit-multiple-files-success.png)
...
1.  Select the items to be published by clicking on the checkbox next to them. Click the **Publish** button when you're ready with your selection.
    ...
    ![](https://github.com/decentraland/docs-creator/blob/main/images/media/linked-wearables/selecting-to-publish.png)
...
3.  Give it a check to the item's your publishing. Click the **Confirm items** button when you're ready.
    ...
    ![](https://github.com/decentraland/docs-creator/blob/main/images/media/linked-wearables/check-items-to-publish.png)
4.  Sign the confirmation of publishing your items in your wallet.

    ![](https://github.com/decentraland/docs-creator/blob/main/images/media/linked-wearables/sign-items-confirmation.png)
5.  Read and check the Terms and Conditions.

    ![](https://github.com/decentraland/docs-creator/blob/main/images/media/linked-wearables/terms-and-conditions.png)
6.  Check your publishing fees. The fees required for published the wearables are described in the [Costs section](linked-wearables.md#costs).
    ...
    ![](https://github.com/decentraland/docs-creator/blob/main/images/media/linked-wearables/publishing-payment.png)
7.  If it's your first time publishing Linked Wearables, you'll need to authorize the Linked Wearables smart contract to operate MANA on your behalf. This step is needed to deduct the MANA used to pay the publication fees from your wallet.
    ...
    ![](https://github.com/decentraland/docs-creator/blob/main/images/media/linked-wearables/first-time-publishing.png)
8.  Pay the publication fee and complete the publishing by performing the transaction. Depending on the congestion of the network, this might take a while.
    ...
    ![](https://github.com/decentraland/docs-creator/blob/main/images/media/linked-wearables/complete-publishing.png)
9.  Success! You have published your items. Your items will go through the curation process a regular collections do. You can communicate with the curator via the forum post.
    ...
    ![](https://github.com/decentraland/docs-creator/blob/main/images/media/linked-wearables/publication-success.png)
...
1.  Select the items with changes by clicking on the checkbox next to them. Click the **Push changes** button when you're ready with your selection.
    ...
    ![](https://github.com/decentraland/docs-creator/blob/main/images/media/linked-wearables/select-push-changes-items.png)
2.  Proceed with the push changes process. As the modal says, these changes will need to go through the curation phase once again.
    ...
    ![](https://github.com/decentraland/docs-creator/blob/main/images/media/linked-wearables/confirm-push-changes.png)
3.  Read and check the Terms and Conditions. Upon accepting them, the items will be ready to be curated again.

    ![](https://github.com/decentraland/docs-creator/blob/main/images/media/linked-wearables/accept-push-changes-terms-and-conditions.png)
