...
![](https://github.com/decentraland/docs-player/blob/main/images/media/marketplace_myland.png)
...
3. You will be shown a view of the Atlas centered on the parcel you selected, with the remaining adjacent parcels you own highlighted. Select the different parcels you want to include in your Estate. ![](https://github.com/decentraland/docs-player/blob/main/images/media/market_estates1.png) ![](https://github.com/decentraland/docs-player/blob/main/images/media/market_estates3.png)
4. Click **Continue**.
5.  Enter a name and description for your Estate. These details will be publicly displayed in the Atlas, just like the name and description for any individual parcel.
    ...
    ![](https://github.com/decentraland/docs-player/blob/main/images/media/market_estates2.png)
...
1.  Navigate to the details page of the parcel or the Estate you'd like to edit and click **Edit**.
    ...
    ![](https://github.com/decentraland/docs-player/blob/main/images/media/marketplace_edit_parcel.png)
2. Click **Submit**.
...
1. Navigate to the details page of the parcel or Estate and click on the three dots and then **Set Operator**. ![](https://github.com/decentraland/docs-player/blob/main/images/media/marketplace_give_permissions_set_operator.png)
2.  Fill the form with the desired info.

    ![](https://github.com/decentraland/docs-player/blob/main/images/media/marketplace_give_permissions.png)
3. Click **Submit**.
...
![](https://github.com/decentraland/docs-player/blob/main/images/media/marketplace_notifications.png)
...
1.  Navigate to the details page of the parcel or the Estate you'd like to transfer and click **Transfer**.
    ...
    ![](https://github.com/decentraland/docs-player/blob/main/images/media/marketplace_transfer_land.png)
...
![](https://github.com/decentraland/docs-player/blob/main/images/media/marketplace_transfer_land_form.png)
