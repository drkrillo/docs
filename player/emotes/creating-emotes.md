...
![](https://github.com/decentraland/docs-creator/blob/main/images/emotes/workspace.png)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/emotes/duplicating_animation.gif) Create a new animation by duplicating the existing one or by clicking on \_\*\*Unlink Action\*\*\_ and then \_\*\*New\*\*\_.
...
![](https://github.com/decentraland/docs-creator/blob/main/images/emotes/deleting_animation.gif) Browsing animations: The ones with an F will be saved, and the ones with 0 will be deleted.
...
![](https://github.com/decentraland/docs-creator/blob/main/images/emotes/deleting_animation2.gif)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/emotes/duplicating_animation2.gif) Duplicating animation clips.
...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-emotes/01_emote_override.gif)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/emotes/keyframe_bones.gif) Setting keyframes on all bones in the first and last frames prevents emote overrides.
...
![](https://github.com/decentraland/docs-creator/blob/main/images/emotes/channel_visibility.gif)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/emotes/mesh_visibility.gif)

Turn off the mesh visibility before exporting!

To export, go to _File_ > _Export_ > _glTF2.0 (.glb, .gltf)_

![](https://github.com/decentraland/docs-creator/blob/main/images/emotes/export_gltf.gif)
...
| ![](https://github.com/decentraland/docs-creator/blob/main/images/emotes/export_settings.png) | ![](https://github.com/decentraland/docs-creator/blob/main/images/emotes/export_settings_GIF.gif) |
| --------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
...
| ![](https://github.com/decentraland/docs-creator/blob/main/images/emotes/sampling_rate.png) | ![](https://github.com/decentraland/docs-creator/blob/main/images/emotes/sampling_rate_GIF.gif) |
| ------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- |
