...
This document gives an overview on the different ways to obtain permissions. See \[publishing]\(\{{< ref "/content/creator/sdk7/publishing/publishing.md" >\}}) for instructions on how to publish once you've obtained these.
