...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/00_creating_wearables_banner.png)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/1_creating_wearables.png)

### **Head**

![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/2_avatar_head.jpeg)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/3_upper_body.png)

_The upper body, or torso, of an avatar. Does not includes the hands._

### **Lower Body**

![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/4_lower_body.png)

_The lower body includes the pelvis and legs of an avatar._

### **Hands**

![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/54_hands.png)

_The hands are the same for Shape A and B, and start on the wrists of an avatar._

### **Feet**

![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/5_feet.png)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/14_body_parts.png)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/12_max_width_height.png) ![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/13_max_depth.png)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/6_maps.png)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/8_normals.gif) ![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/9_backface_culling.png)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/10_normals_face.png)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/50_armature.png)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/53_ignore_leaf_bones.png)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/21_eyes.png) ![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/22_eyebrows.png) ![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/23_eyes_mask_uv.jpeg)

_Eyes and Eyewbrows use the same mesh and UV map._

![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/24_mouth.png) ![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/25_mouth_mask_uv.jpeg)

_Mouth mesh and UV map._

To visualize the final result you’ll need to use these nodes (in Blender):

![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/26_eyes_nodes.png) ![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/27_eyes_alpha.png)

**Masks:** The Avatar Editor has different color options that players can choose from to customize their avatars.

![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/28_eyes_tone.png)

These color choices are applied to a specific mask in the wearable.

![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/29_eyes_mask.png) ![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/30_eyes_base.png)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/55_gloves.png)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/56_dclwatch.png)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/31_hair_base.png)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/32_hair_mat.png) ![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/33_hair_tx.png) ![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/49_tint_hair.gif)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/15_avatar_skin_mat.png)

Each base mesh comes with its own skin texture.

![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/16_Avatar_MaleSkinBase.png) ![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/17_Avatar_FemaleSkinBase.png)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/18_skin_tone.png)
...
\<img src="/images/wearables-and-emotes/creating-wearables/19\_skin\_uv.png"width="600"/>
...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/20_wearables_uv.png)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/34_rig.gif)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/35_head_cuts.png)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/51_export_wearables.png)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/52_export_wearables.png)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/36_60_1.gif)

2. Now, in pose mode you can rotate the arms 60°.

![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/37_60_2.gif)

3. You can edit your mesh in A-Pose instead of T-pose.

![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/38_60_3.gif)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/39_60_4.gif)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/40_joints.gif)

A good way to ensure that everything is deforming correctly is to do a weight paint like the following example:

![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/41_joint_weight.png) ![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/42_joint_weight_02.png)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/43_skirt.png)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/44_skirt.gif)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/45_hat.png)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/creating-wearables/46_poly_count.png)
