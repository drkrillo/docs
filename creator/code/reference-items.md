...
![](https://github.com/decentraland/docs-creator/blob/main/images/editor/door-names.png)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/editor/EntityNames.png)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/editor/tags.png)

{% hint style="info" %}
**💡 Tip**: A single entity can have multiple tags assigned to it.

![](https://github.com/decentraland/docs-creator/blob/main/images/editor/tags-multiple.png)
{% endhint %}
...
![](https://github.com/decentraland/docs-creator/blob/main/images/editor/restart-button.png)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/editor/door-actions.png)
