...
{% hint style="info" %}
**💡 Tip**: If you prefer to create your scenes with only no-code tools, see [Scene Editor in Creator Hub](../get-started/about-editor.md).
{% endhint %}
...
Explore the **Asset packs** on the bottom section of the Scene Editor in Creator Hub, drop in a couple of items and adjust their positions. For the sake of this tutorial, any items will do for now.
...
![](../../../.gitbook/assets/running-preview.png)
...
![](../../../.gitbook/assets/avocado-babylon.png)
...
2.  Drag the **avocado.glb** file onto the region on the Scene Editor UI and click **Import**.
    ...
    ![](../../../.gitbook/assets/import-avocado.png)
...
![](../../../.gitbook/assets/avocado-in-local-assets.png)
...
![](../../../.gitbook/assets/avocado-components.png)
...
![](../../../.gitbook/assets/logs-avocado.png)

{% hint style="warning" %}
\*\*📔 Note\*\*: For an entity to be clickable, it must have a collider geometry. The model used here already includes one. See the \[Colliders]\(../3d-modeling/colliders.md) section for workarounds for models that don't include a collider geometry.
{% endhint %}
...
Your code can also do things with the items you added visually in the Scene Editor in Creator Hub. You can fetch these items by name in your code, using the function `engine.getEntityOrNullByName()`. Use the name for the item that you see written on the [entity tree](../get-started/scene-editor-essentials.md#the-entity-tree).
