...
Color values can passed as properties of different components, like [Materials](materials.md), [Text](text.md) or different properties of [UI entities](../2d-ui/onscreen-ui.md). Color values can either be of type `Color3` or `Color4`.
