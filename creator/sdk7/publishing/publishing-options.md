...
This document gives an overview on the different ways to obtain permissions. See [publishing](../sdk7/publishing/publishing.md) for instructions on how to publish once you've obtained these.
...
{% hint style="warning" %}
**📔 Note**: You can also deploy scenes to a test server where players are not around. The same permissions per parcel apply when deploying to the test server, see [publishing](../sdk7/publishing/publishing.md#the-test-server) for more details.
{% endhint %}
