...
When referencing data from a [component](../sdk7/architecture/entities-components.md), you can either fetch the mutable or the read-only (immutable) version.
...
This practice follows the principles of [data oriented programming](../sdk7/architecture/data-oriented-programming.md). It's also gradually being adopted as an industry standard practice in the gaming, because of how much of an improvement it makes.
