...
* [Assigning Wearables or Emotes reward](api.md#assigning-wearables-or-emotes-reward)
* [Securing the Rewards Dispenser](api.md#securing-the-rewards-dispenser)
  * [Date Range Protection](api.md#date-range-protection)
  * [Limit Assignments](api.md#limit-assignments)
  * [Captcha Protection](api.md#captcha-protection)
  * [Beneficiary Signature](api.md#beneficiary-signature)
  * [Connected to Decentraland](api.md#connected-to-decentraland)
  * [Position inside Decentraland](api.md#position-inside-decentraland)
...
![](../images/rewards/dispenser-config.png)
...
If your users interact with the dispenser directly within your scene, your keys are exposed in code that can be accessed and replicated through the browser. To minimize the risk of automation and abuse, you can enable the _Captcha challenge_ flag on your dispenser. This flag requires users to solve a captcha before a wearable or emote is assigned to them, adding an extra layer of security.
...
{% hint style="info" %}
This is an example of what a captcha looks like: ![](../images/rewards/captcha.png)
{% endhint %}
