...
![Scene name](https://github.com/decentraland/docs-creator/blob/main/images/editor/publish-options.png)
...
5. The publication process will then start. Stages **1** and **2** are necessary for your scene to be playable, once done a **Jump In** button appears. You don't need to wait for **Stage 3** to try out your scene. ![Scene name](https://github.com/decentraland/docs-creator/blob/main/images/editor/deploy-steps.png)
...
![Scene name](https://github.com/decentraland/docs-creator/blob/main/images/editor/publish-to-test-server.png)
...
![Scene name](https://github.com/decentraland/docs-creator/blob/main/images/editor/publish-to-granted-land.png)
