...
To open the Debug Panel, you can click the ![](../images/debug-icon.png) icon on the top-right corner. Then select the **Web Requests** tab and click **Open Chrome Devtools**.
