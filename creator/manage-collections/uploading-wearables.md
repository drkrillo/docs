...
![](/.gitbook/assets/images/wearables-and-emotes/uploading-wearables/01_new_item.png)
...
![](/.gitbook/assets/images/wearables-and-emotes/uploading-wearables/03_body_shape.png)

#### **Rarity**

Select the Rarity of your item.

![](/.gitbook/assets/images/wearables-and-emotes/uploading-wearables/04_rarity.png)
...
![](/.gitbook/assets/images/wearables-and-emotes/uploading-wearables/05_category.png)
...
![](/.gitbook/assets/images/wearables-and-emotes/uploading-wearables/06_thumbnail.png)
...
![](/.gitbook/assets/images/wearables-and-emotes/uploading-wearables/07_thumbnail.png)
{% endhint %}
...
![](/.gitbook/assets/images/wearables-and-emotes/uploading-wearables/08_properties.png)
...
![](/.gitbook/assets/images/wearables-and-emotes/uploading-wearables/02_mouth_wearable.png)

After that uploading your wearables you will end up with a screen like this, that shows the items in your collection.

![](/.gitbook/assets/images/wearables-and-emotes/uploading-wearables/11_list_wearables.png)
...
![](/.gitbook/assets/images/wearables-and-emotes/uploading-wearables/25_enable_sales.png)
...
![](/.gitbook/assets/images/wearables-and-emotes/uploading-wearables/12_set_price.png)
...
![](/.gitbook/assets/images/wearables-and-emotes/uploading-wearables/13_click_item.png)
...
![](/.gitbook/assets/images/wearables-and-emotes/uploading-wearables/14_editor.png)
...
![](/.gitbook/assets/images/wearables-and-emotes/uploading-wearables/26_outline.png)
...
![](/.gitbook/assets/images/wearables-and-emotes/uploading-wearables/15_add_variation.png)
...
![](/.gitbook/assets/images/wearables-and-emotes/uploading-wearables/16_add_male_representation_01.png) ![](/.gitbook/assets/images/wearables-and-emotes/uploading-wearables/17_add_male_representation_02.png)

### **Preview**

To preview your wearable, hover your mouse over the wearable icon on the top left and click on the eye symbol.

![](/.gitbook/assets/images/wearables-and-emotes/uploading-wearables/18_preview_wearables_03.gif)
...
![](/.gitbook/assets/images/wearables-and-emotes/uploading-wearables/19_edit_avatar_wearable_03.gif)
...
![](/.gitbook/assets/images/wearables-and-emotes/uploading-wearables/20_test_in_world_01.png)
...
![](/.gitbook/assets/images/wearables-and-emotes/uploading-wearables/23_see_in_world.png)

Once you select See in world, a new tab will open on your browser, and you will get this message.

![](/.gitbook/assets/images/wearables-and-emotes/uploading-wearables/27_wearable_preview.png)
...
![](/.gitbook/assets/images/wearables-and-emotes/uploading-wearables/28_wearable_world.gif)
