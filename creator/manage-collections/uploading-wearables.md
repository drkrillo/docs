...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/uploading-wearables/01_new_item.png)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/uploading-wearables/03_body_shape.png)

#### **Rarity**

Select the Rarity of your item.

![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/uploading-wearables/04_rarity.png)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/uploading-wearables/05_category.png)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/uploading-wearables/06_thumbnail.png)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/uploading-wearables/07_thumbnail.png)
{% endhint %}
...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/uploading-wearables/08_properties.png)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/uploading-wearables/02_mouth_wearable.png)

After that uploading your wearables you will end up with a screen like this, that shows the items in your collection.

![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/uploading-wearables/11_list_wearables.png)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/uploading-wearables/25_enable_sales.png)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/uploading-wearables/12_set_price.png)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/uploading-wearables/13_click_item.png)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/uploading-wearables/14_editor.png)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/uploading-wearables/26_outline.png)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/uploading-wearables/15_add_variation.png)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/uploading-wearables/16_add_male_representation_01.png) ![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/uploading-wearables/17_add_male_representation_02.png)

### **Preview**

To preview your wearable, hover your mouse over the wearable icon on the top left and click on the eye symbol.

![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/uploading-wearables/18_preview_wearables_03.gif)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/uploading-wearables/19_edit_avatar_wearable_03.gif)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/uploading-wearables/20_test_in_world_01.png)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/uploading-wearables/23_see_in_world.png)

Once you select See in world, a new tab will open on your browser, and you will get this message.

![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/uploading-wearables/27_wearable_preview.png)
...
![](https://github.com/decentraland/docs-creator/blob/main/images/wearables-and-emotes/uploading-wearables/28_wearable_world.gif)
